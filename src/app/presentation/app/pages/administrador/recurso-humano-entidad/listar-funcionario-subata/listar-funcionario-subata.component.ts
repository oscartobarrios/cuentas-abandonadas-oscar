...
@Component({
  selector: 'app-listar-funcionario-subata',
  templateUrl: './listar-funcionario-subata.component.html',
  styleUrls: ['./listar-funcionario-subata.component.css']
})
export class ListarFuncionarioSubataComponent implements OnInit {
  usuario : any;
  ...
  ngOnInit(): void {
    ...
    {
      this._servicioAdministrativo.ListarFuncionarioEntidadPorTipo("SUBASTA").subscribe((ResultData) => {
    ...
    {
      this._servicioAdministrativo.ListarFuncionarioEntidadPorTipoIdOrganizacion("SUBASTA",this.identidad).subscribe((ResultData) => {
