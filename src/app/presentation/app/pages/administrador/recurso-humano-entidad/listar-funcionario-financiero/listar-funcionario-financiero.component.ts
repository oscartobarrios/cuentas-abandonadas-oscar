...
@Component({
  selector: 'app-listar-funcionario-financiero',
  templateUrl: './listar-funcionario-financiero.component.html',
  styleUrls: ['./listar-funcionario-financiero.component.css']
})
