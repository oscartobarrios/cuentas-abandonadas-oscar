...
@Component({
  selector: 'app-listar-revisor-fiscal',
  templateUrl: './listar-revisor-fiscal.component.html',
  styleUrls: ['./listar-revisor-fiscal.component.css']
})
export class ListarRevisorFiscalComponent implements OnInit {
  usuario : any;
  ...
  {
    this._servicioAdministrativo.ListarFuncionarioEntidadPorTipo("FISCAL").subscribe((ResultData) => {
  ...
  {
    this._servicioAdministrativo.ListarFuncionarioEntidadPorTipoIdOrganizacion("FISCAL",this.identidad).subscribe((ResultData) => {
